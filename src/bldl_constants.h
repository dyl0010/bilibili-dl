...
namespace bldl {
	struct Constants {
        ...
        inline static const std::string url_bilibili_audio = "https://www.bilibili.com/audio/";
        ...
        inline static const std::string audio_service_web_url = "https://www.bilibili.com/audio/music-service-c/web/url";
        ...
        inline static const std::string progress_spinner_text = " Parsing addresses ";
	};
}